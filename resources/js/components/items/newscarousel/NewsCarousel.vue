...
const selectedStyle = computed(() => {
	...
	if (style.value?.item?.layout.toLowerCase() === "newscarousel") {
		return (selectedStyle.value = style.value.item.selectedStyles)
	}
	return "style1"
})
</script>
<template>
	<section :id="item.id" class="editable text-center" data-fields="">
		<div class="container-fluid">
			<div class="col-md-12">
				<img
					:src="`${siteUrl}/components/items/newscarousel/${selectedStyle}.png`"
					alt=""
				/>
			</div>
		</div>
