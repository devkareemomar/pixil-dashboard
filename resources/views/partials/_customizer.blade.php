<div class="customizer">
    <div class="customizer__head">
        <h4 class="customizer__title">{{ __('Customizer') }}</h4>
        <span class="customizer__sub-title">{{ __('Customize your overview page layout') }}</span>
