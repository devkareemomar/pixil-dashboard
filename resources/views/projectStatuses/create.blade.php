...
@section('title', __('Create Project Statuses'))
@section('description', __('Create a new Project Status'))
...
<div class="container-fluid pb-30 pt-30">
	...
	<div class="card mb-80">
		<div class="card-header color-dark fw-500">
			<h4>{{ __('Create New Project Status') }}</h4>
		</div>
		<div class="card-body">
			<div class="row">

				<form enctype="multipart/form-data" class="col-10 offset-1"
					action="{{ route('projectStatuses.store') }}" method="POST" class="col-11 m-auto ">
					@csrf
					...
					<div class="row">
						...
						<div class="col-4">
							<div class="form-check form-switch">
								<input class="form-check-input" type="checkbox" value="1" role="switch"
									id="flexSwitchCheckChecked" name="is_new" checked>
						...
						<div class="col-4">
							<div class="form-check form-switch">
								<input class="form-check-input" type="checkbox" value="1" role="switch"
									id="flexSwitchCheckChecked" name="is_completed" checked>
					...
					<br>
					<button type="submit" class="btn btn-primary">{{ __('Create Project Status') }}</button>
				</form>
			</div>
		</div>
	</div>
