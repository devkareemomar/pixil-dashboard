					...
					<div class="col-xxl-3 col-xl-4 col-md-6 col-sm-8">
						<div class="edit-profile">
							<div class="edit-profile__logos">
								...
								<img class="dark" src="{{ asset('storage/' . $setting?->dark_application_logo_image) }}"
									alt="">
									@endif
									@if($setting?->dark_application_logo_image)
								<img class="light" src="{{ asset('storage/' . $setting?->application_logo_image) }}"
									alt="">
									@endif
							</div>
										...
										<div class="edit-profile__body">
											...
											<div class="admin-condition">
												<div class="checkbox-theme-default custom-checkbox">
													...
													<label for="check-1">
														<span class="checkbox-text">{{ __('Creating an account means
															you’re okay with our') }} <a href="#"
																class="color-primary">{{ __('Terms of Service') }}</a>
															{{ __('and') }} <a href="#" class="color-primary">{{
								...
								<div class="px-20">
									...
									<div class="button-group d-flex align-items-center justify-content-center">
										<ul class="admin-socialBtn">
											...
											<!-- Add similar buttons for other social platforms -->
										</ul>
									</div>
								</div>
								<div class="admin-topbar">
									<p class="mb-0">
										{{ __('Don\'t have an account?') }} <a href="{{ route('login') }}"
											class="color-primary">{{ __('Sign In') }}</a>
									</p>
								</div>
							</div>
						</div>
